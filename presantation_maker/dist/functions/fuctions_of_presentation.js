...
const const_for_presantation_1 = require("../types/const_for_presantation");
function generateId() {
...
function addSlide(presentation) {
    const newSlide = {
        id: generateId(),
        slideObjects: [],
        background: const_for_presantation_1.DEFAULT_BACKGROUND
    };
...
function addText(slide, x = const_for_presantation_1.DEFAULT_POSITIONS.X, y = const_for_presantation_1.DEFAULT_POSITIONS.Y, text = "") {
    const newText = {
        id: generateId(),
        type: "text",
        x,
        y,
        w: const_for_presantation_1.TEXT_OBJECT_DEFAULTS.WIDTH,
        h: const_for_presantation_1.TEXT_OBJECT_DEFAULTS.HEIGHT,
        text,
        fontSize: const_for_presantation_1.TEXT_OBJECT_DEFAULTS.FONT_SIZE,
        fontFamily: const_for_presantation_1.TEXT_OBJECT_DEFAULTS.FONT_FAMILY,
        fontWeight: const_for_presantation_1.TEXT_OBJECT_DEFAULTS.FONT_WEIGHT,
        textDecoration: const_for_presantation_1.TEXT_OBJECT_DEFAULTS.TEXT_DECORATION,
        textAlign: const_for_presantation_1.TEXT_OBJECT_DEFAULTS.TEXT_ALIGN,
        color: const_for_presantation_1.TEXT_OBJECT_DEFAULTS.COLOR,
        shadow: {
            color: const_for_presantation_1.TEXT_OBJECT_DEFAULTS.SHADOW.COLOR,
            blur: const_for_presantation_1.TEXT_OBJECT_DEFAULTS.SHADOW.BLUR
        }
    };
    return {
        ...slide,
...
function addImage(slide, x = const_for_presantation_1.DEFAULT_POSITIONS.X, y = const_for_presantation_1.DEFAULT_POSITIONS.Y, src) {
    const newImage = {
        id: generateId(),
        type: "image",
        x,
        y,
        w: const_for_presantation_1.IMAGE_OBJECT_DEFAULTS.WIDTH,
        h: const_for_presantation_1.IMAGE_OBJECT_DEFAULTS.HEIGHT,
        src
    };
    return {
        ...slide,
